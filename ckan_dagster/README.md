...
You can start writing assets in `ckan_dagster/assets.py`. The assets are automatically loaded into the Dagster code location as you define them.
...
Tests are in the `ckan_dagster_tests` directory and you can run tests using `pytest`:

```bash
pytest ckan_dagster_tests
```
