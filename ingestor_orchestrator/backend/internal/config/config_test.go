...
func TestLoadDefaults(t *testing.T) {
	for _, name := range []string{
		"INGEST_ORCH_GO_ADDRESS",
		"INGEST_ORCH_MYSQL_HOST",
		"INGEST_ORCH_MYSQL_PORT",
		"INGEST_ORCH_MYSQL_USER",
		"INGEST_ORCH_MYSQL_PASSWORD",
		"INGEST_ORCH_MYSQL_DATABASE",
		"INGEST_ORCH_IGGY_ADDRESS",
		"INGEST_ORCH_IGGY_USERNAME",
		"INGEST_ORCH_IGGY_PASSWORD",
		"INGEST_ORCH_IGGY_STREAM",
		"INGEST_ORCH_IGGY_TOPIC",
		"INGEST_ORCH_IGGY_TOPIC_RETRY",
		"INGEST_ORCH_IGGY_TOPIC_RESULTS",
		"INGEST_ORCH_SCHEDULER_INTERVAL_MINUTES",
	} {
		t.Setenv(name, "")
	}
	cfg := Load()
